    ...
    options: {
      ...
      storySort: {
        order: [
          ...
          "Components",
          [
            // Within Menu, foundation → trigger → common composed → advanced.
            "Menu",
            [
              "Menu",
              "Menu toggle",
            ...
            // Within Forms, group from primitive → composed → grouped
            // controls → date/time → patterns → helper. The remaining
            // categories sort alphabetically (Storybook's default).
            "Forms",
            [
              "Form",
              "FormControl",
