          ...
          <div style={{ padding: 24, display: "grid", gap: 16 }}>
            <DemoFrame height={300}>
              ...
              >
                ...
                {/* PF6's BackToTop is position:absolute; we render it INSIDE
                    the scroll container and rely on `position: relative` on
                    the container above to anchor the button to its bottom-
                    right corner. Without that anchor the button would
                    position relative to the viewport and float somewhere
                    outside the demo. isAlwaysVisible keeps it on-screen
                    so the doc reader can spot it without scrolling first. */}
                <BackToTop
