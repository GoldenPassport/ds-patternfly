...
import {
  Variants,
  WithCount,
} from "../../examples/components/NotificationBadge.example.js";
import notificationBadgeExampleSrc from "../../examples/components/NotificationBadge.example.tsx?raw";
  ...
  render: () => (
    ...
    >
      ...
      >
        <Card>
          <Example
            source={notificationBadgeExampleSrc}
            region="Variants"
            fileName="NotificationBadge.example.tsx"
          >
            <Variants />
          </Example>
        </Card>
