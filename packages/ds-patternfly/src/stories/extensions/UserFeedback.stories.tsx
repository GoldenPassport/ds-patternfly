...
import { InlineFeedbackHandler } from "../../examples/extensions/UserFeedback.example.js";
import userFeedbackExampleSrc from "../../examples/extensions/UserFeedback.example.tsx?raw";
  ...
  render: () => (
    ...
    >
      ...
      >
        <Card>
          <Example
            source={userFeedbackExampleSrc}
            region="InlineFeedbackHandler"
            fileName="UserFeedback.example.tsx"
          >
            <InlineFeedbackHandler />
          </Example>
        </Card>
      </Section>
