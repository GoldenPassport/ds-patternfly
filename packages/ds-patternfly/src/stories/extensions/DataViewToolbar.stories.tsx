...
import { FiltersActionsPagination } from "../../examples/extensions/DataViewToolbar.example.js";
import dataViewToolbarExampleSrc from "../../examples/extensions/DataViewToolbar.example.tsx?raw";
  ...
  render: () => (
    ...
    >
      ...
      >
        <Card>
          <Example
            source={dataViewToolbarExampleSrc}
            region="FiltersActionsPagination"
            fileName="DataViewToolbar.example.tsx"
          >
            <FiltersActionsPagination />
          </Example>
        </Card>
      </Section>
