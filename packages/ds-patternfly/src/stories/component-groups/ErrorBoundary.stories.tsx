...
import { CatchingAThrownError } from "../../examples/component-groups/ErrorBoundary.example.js";
import errorBoundaryExampleSrc from "../../examples/component-groups/ErrorBoundary.example.tsx?raw";
    ...
    >
      ...
      >
        <Card>
          ...
          />
          <Example
            source={errorBoundaryExampleSrc}
            region="CatchingAThrownError"
            fileName="ErrorBoundary.example.tsx"
          >
            <CatchingAThrownError />
          </Example>
        </Card>
      </Section>
      ...
      >
        <Card>
          <Example source={errorBoundaryExampleSrc} fileName="ErrorBoundary.example.tsx" />
        </Card>
      </Section>
